...
public class TD_Project : ModuleRules
{
	public TD_Project(ReadOnlyTargetRules Target) : base(Target)	
	{
		...
		PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore", "EnhancedInput", "GameplayTags", "GameplayAbilities", "GameplayTasks", "AIModule", "NetCore", "ModelViewViewModel", "FieldNotification" });
